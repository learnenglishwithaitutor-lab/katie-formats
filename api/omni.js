...
Setting: Same cozy home bedroom, soft natural light, waist-up framing. Keep the look consistent across clips.
Format: Vertical 9:16, phone-camera UGC style.
...
- Movement MUST be word-anchored (At "word," gesture). NEVER emit timestamps (no 0:00-0:03) — fabricated times cause rushing.
- Keep the SAME setting and SAME warm, upbeat baseline energy across clips; only the per-word delivery notes vary with the words' meaning.
